...
public class BatteriaDiTestService {
	...
	public void testInserisciDipendenteInSocieta() {
		...
		try {
			nuovaSocieta = new Societa("Tentativo ", "Via Mosca, 10 " + nowInMillisecondi,
					new SimpleDateFormat("dd/MM/yyyy").parse("10/12/1970"));
			...
			nuovoDipendente = new Dipendente("Alessio", "Conti" + nowInMillisecondi,
					new SimpleDateFormat("dd/MM/yyyy").parse("04/28/2022"), 250000);
	...
	public void testModificaDipendente() {
		...
		try {
			societaTemp = new Societa("Tentativo2", "Via Mosca, 12",
					new SimpleDateFormat("dd/MM/yyyy").parse("20/01/2001"));

			societaService.inserisciNuovo(societaTemp);

			dipendenteTemp = new Dipendente("Mario", "Rossi", new SimpleDateFormat("dd/MM/yyyy").parse("03/05/1980"),
					250000);
	...
	public void testSocietaConDipendentiConRedditoAPartireDa30000() {
		...
		try {
			...
			nuovaSocieta = new Societa("Solving Team", "Via Mosca, 14",
					new SimpleDateFormat("dd/MM/yyyy").parse("05/05/1989"));
			...
			nuovoDipendente2 = new Dipendente("Giorgio", "Luca", new SimpleDateFormat("dd/MM/yyyy").parse("07/02/1978"),
					36000);

			nuovoDipendente3 = new Dipendente("Sofia", "Arnese", new SimpleDateFormat("dd/MM/yyyy").parse("03/05/1999"),
					31000);
		...
		System.out.println("testSocietaConDipendentiConRalAPartireDa30000 concluso.....");
	}

	public void testDipendentePiuAnzianoTraAziendePrimaDei90() {
		...
		try {
			...
			nuovaSocieta = new Societa("Solving Alliance", "Via Mosca, 20",
					new SimpleDateFormat("dd/MM/yyyy").parse("05/05/2001"));

			nuovaSocieta2 = new Societa("Solving Unification", "Via Mosca, 22",
					new SimpleDateFormat("dd/MM/yyyy").parse("18/09/1900"));

			nuovaSocieta3 = new Societa("Solving Legacy", "Via Mosca, 24",
			...
			nuovoDipendente = new Dipendente("Luca", "Marini", new SimpleDateFormat("dd/MM/yyyy").parse("03/05/1980"),
					25000);

			nuovoDipendente2 = new Dipendente("Aldo", "Verdi", new SimpleDateFormat("dd/MM/yyyy").parse("07/02/1978"),
					36000);

			nuovoDipendente3 = new Dipendente("Andrea", "Moro", new SimpleDateFormat("dd/MM/yyyy").parse("03/05/1999"),
					31000);
		...
		List<Dipendente> result = dipendenteService.trovaDipendentiPiuAnzianiDiSocietaFondatePrimaDei90();
		for (Dipendente dipendenteItem : result)
			System.out.println(dipendenteItem);

		System.out.println("testDipendentePiuAnziano concluso.....");
	}
}
